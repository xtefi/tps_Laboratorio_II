    ...
    public partial class FormNuevoTransportista : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Transportista tr = new Transportista(txtCuit.Text, txtNombre.Text, txtPatente.Text, Convert.ToInt64(numToneladas.Value), TipoGrano(), DateTime.Now, DateTime.Today);
